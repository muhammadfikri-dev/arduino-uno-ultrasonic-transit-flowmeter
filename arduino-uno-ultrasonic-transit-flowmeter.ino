/**
 * =========================================================================================
 * Project     : Arduino Uno Clamp-On Ultrasonic Transit-Time Water Flowmeter
 * Platform    : Arduino Uno / ATmega328P
 * Framework   : Arduino IDE 2.0+
 * Author      : Muhammad Fikri
 * License     : MIT
 * Description : Non-invasive water pipe flowmeter calculating nanosecond transit-time delta between upstream/downstream 1MHz ultrasonic transducers to measure flow velocity.
 * =========================================================================================
 */
...
void setup() {
    ...
    Serial.println(F("================================================================="));
    Serial.println(F(" Arduino Uno Clamp-On Ultrasonic Transit-Time Water Flowmeter"));
